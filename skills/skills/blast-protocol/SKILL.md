---
name: blast-protocol
description: Build deterministic, self-healing automation using the B.L.A.S.T. (Blueprint, Link, Architect, Stylize, Trigger) protocol and the A.N.T. 3-layer architecture. Use when building robust, production-grade automation pipelines, full-stack tools, and API integrations.
---
