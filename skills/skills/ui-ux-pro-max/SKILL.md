---
name: ui-ux-pro-max
description: "UI/UX design intelligence v2.0. AI-powered Design System Generator, 100+ reasoning rules, 67 styles, 96 palettes, 57 font pairings. Generates complete design systems, component guidelines, and stack-specific code structure (React, Vue, Tailwind, etc.). Auto-detects product type and industry for tailored recommendations."
---
...
```bash
# Navigate to skill directory first if needed, or use absolute path
cd /Users/jatinbhutani/.gemini/antigravity/skills/ui-ux-pro-max
